...
vim.diagnostic.config {
  ...
  signs = {
    text = {
      ...
      [vim.diagnostic.severity.WARN] = '⚠', -- Icon for Warn
...
require('lazy').setup({
  ...
  -- LSP Plugins
  {
    ...
    dependencies = {
      ...
      -- providing helpful management commands, and mapping mason.nvim packages
      -- to nvim-lspconfig configurations.
  ...
  { -- Autoformat
    ...
    opts = {
      ...
      format_on_save = function(bufnr)
        ...
        local disable_filetypes = { c = true, cpp = true, ruby = true, typescript = true, javasctrip = true }
  ...
  { -- Highlight, edit, and navigate code
    ...
    -- branch = 'main',
    config = function()
      -- local filetypes = { 'go', 'ruby', 'javascript', 'typescript' }
      local filetypes = { 'bash', 'c', 'diff', 'html', 'lua', 'markdown', 'markdown_inline', 'query' }
